                ...
                <el-card class="box-card">
                    ...
                    <div class="text item">
                      <el-form :model="formadd" status-icon :rules="formRules" ref="formadd" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item>
                                <el-button type="primary" @click="submitForm('formadd')">修改</el-button>
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        ...
        //   alert("前端验证通过，可以发送给后端!");
         ...
         this.axios.post('http://127.0.0.1:3000/users/editshop',qs.stringify(parms),{'header':{'Content-Type':'application/x-www-form-urlencoded' }})
          .then(response=>{
